  ...
  return (
    <section className="card" data-testid="striosome-pathway-card">
      <div className="button-row">
        ...
        <TierBadge tier={Tier.ROBUST} justification="Mouse striosomal D1/D2 to SNc pathway via central-zone GPe." />
        <TierBadge tier={Tier.PLAUSIBLE} justification="Human/primate confirmation remains pending." />
      </div>
