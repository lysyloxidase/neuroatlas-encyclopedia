...
export default function MicroanatomyPage() {
  const level2Count = structures.filter(
    (structure) => structure.level === 2,
  ).length;
  ...
  return (
    <section className="container section">
      ...
      <h1>Microanatomy</h1>
      <p className="lead">
        {level2Count} Level 2 entries across lamination, Brodmann, von Economo,
        hippocampus, amygdala, thalamus, hypothalamus, brainstem, cerebellar
        microcircuits, and basal ganglia compartments.
      </p>
